  ...
  return (
    <div className={`bg-zinc-950  screen px-5 `} id="works">
      <div className="flex flex-col mx-auto max-w-screen-xl gap-5  overflow-hidden">
        <div className="relative h-screen my-auto max-h-700:mb-96 min-h-700:mb-48 md:mb-72 xl:mb-52 lg:mt-10 xl:mt-1 ">
          <div
          ...
          >
            ...
            <div className="">
              <div className="flex flex-col mt-24  xl:mt-36 w-full px-2 font-general-sans transition duration-1000 ease-in-out group-hover:blur-md ">
                ...
                <div className="flex mx-auto flex-row gap-2 ">
                      ...
                      >
                        ...
                        >
                          <p className="text-xs lg:text-base font-lato custom-paragraphMb lg:custom-paragraph  text-left leading-none">
                            ...
                            deliver reliable and efficient software applications
                            that drive an organization forward.
                          </p>
                        </div>
                      </div>
                    </div>

...
const ContactForm: React.FC<ContactUseProps> = ({
  ...
  return (
    <div className="py-10 px-5 bg-contact-bg  text-white">
      <div className="flex flex-col mx-auto max-h-screen max-w-screen-lg gap-6 mb-16 lg:mt-24 ">
        ...
        {menuOpen && (
          <div className="absolute font-lato right-8 top-24 w-36 h-50 bg-white text-zinc-900 flex items-center justify-center rounded-2xl">
          ...
          <div className="flex mt-3 lg:flex-row gap-3">
            <div className="w-full p-3 border rounded-full text-white">
              <select
                ...
                className=" placeholder-transparent ring-offset-transparent w-full bg-transparent rounded-full border-none outline-none  dark:placeholder-transparent  "
                onChange={handleChange}
              >
